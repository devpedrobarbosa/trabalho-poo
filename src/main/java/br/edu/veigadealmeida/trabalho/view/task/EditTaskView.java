...
public class EditTaskView extends javax.swing.JFrame {
     ...
     */
    public EditTaskView(Employee employee, Task task, ProjectOverview overview, ProjectManager projectManager, CustomerManager customerManager, EmployeeManager employeeManager, TaskManager taskManager) {
        initComponents();
        ...
        if(task.getEndTerm() != null)
            endTermField.setText(new SimpleDateFormat("dd/MM/yyyy").format(task.getEndTerm()));
    }
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Alterar Tarefa");
    ...
    private void addClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addClick
        ...
        try {
            taskManager.getAllTypes().removeIf(t -> t.getId().equals(task.getId()));
            final Date endTerm = endTermField.getText().replace("/", "").replace(" ", "").trim().isEmpty() ? null : new SimpleDateFormat("dd/MM/yyyy").parse(endTermField.getText());
            task.setName(name);
            task.setResponsibleEmployee(selectedEmployee.getName());
            task.setEndTerm(endTerm);
