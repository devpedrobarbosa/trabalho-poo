 ...
 * @author suporte
 */
public class PMPAppView extends javax.swing.JFrame {
    ...
    */
    public enum Pages {
        CUSTOMERS(o -> new CustomersTab((Employee) o)),
    ...
    private static PMPAppView instance;
     ...
     * @param employee
     */
    public PMPAppView(Employee employee) { //Iniciando tela principal
        ...
        handleSwitch(Pages.CUSTOMERS, null, partnersTab); //Realiza a abertura da página padrão
    }
    ...
    */
    ...
    private void switchToPartners(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_switchToPartners
        // TODO add your handling code here:
        handleSwitch(Pages.CUSTOMERS, null, (JButton) evt.getSource());
