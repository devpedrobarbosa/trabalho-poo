...
public class EditCustomerView extends javax.swing.JFrame {
     ...
     * @param partner
     */
    public EditCustomerView(CustomerManager partnerManager, EmployeeManager employeeManager, Customer partner) {
        initComponents();
        ...
        representativeField.setText(partner.getRepresentative());
        ...
        responsibleEmployeeSelector.setSelectedItem(partner.getResponsibleEmployee());
        loginField.setText(partner.getLogin());
    ...
    private void initComponents() {
        ...
        title.setText("Editar Associado");
        ...
        panel.add(editButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 310, 120, -1));
    ...
    private void editClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editClick
        ...
        partner.setRepresentative(representative);
        partner.setResponsibleEmployee(employee.getName());
        partner.setLogin(login);
        partner.setPassword(password);
        partnerManager.getAllTypes().add(partner);
